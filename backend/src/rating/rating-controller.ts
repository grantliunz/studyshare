...
export const getRatingByAnswer= async (req: Request<{ answerId: string }, {}, {}>, res: Response) => {
  try {
...
export const getRatingByComment = async (req: Request<{ commentId: string }, {}, {}>, res: Response) => {
  try {
...
export const getRating = async (req: Request<{ ratingId: string }, {}, {}>, res: Response) => {
  try {
...
export const updateRating = async (req: Request<{ ratingId: string }, {}, CreateRatingDTO>, res: Response) => {
  try {
    ...
    rating.Downvotes = req.body.Downvotes !== undefined ? req.body.Downvotes : 0;
...
export const deleteRating = async (req: Request<{ ratingId: string }, {}, {}>, res: Response) => {
  try {
    // Get the rating by its ID
    const rating = await Rating.findById(req.params.ratingId);
