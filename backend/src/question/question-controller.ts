...
export const createQuestion = async (req: Request<{ assessmentId: string }, {}, CreateQuestionDTO>, res: Response) => {
  try {
    ...
    const question = new Question({ QuestionNumber, Image, QuestionText, Author });
...
export const getQuestion = async (req: Request<{ id: string }, {}, {}>, res: Response) => {
  try {
...
export const updateQuestion = async (req: Request<{ id: string }, {}, CreateQuestionDTO>, res: Response) => {
  try {
...
export const deleteQuestion = async (req: Request<{ id: string }, {}, {}>, res: Response) => {
  try {
